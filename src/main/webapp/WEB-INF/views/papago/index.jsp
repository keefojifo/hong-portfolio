...
<meta charset="UTF-8">
  ...
  <title>charleshong portfolio</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">portfolio introduction</a>
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0">홍철기 포트폴리오를 소개합니다</h1>
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">JAVA - Server - Network - Security </p>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
            ...
            <img class="img-fluid" src="/resources/img/papago.png" alt="파파고 이미지">
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
            ...
            <img class="img-fluid" src="/resources/img/ajax.png" alt="">
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto">
          <p class="lead"> 박경훈 성생님 <br>잘 가르쳐 주셔서 감사합니다.</p>
        </div>
        <div class="col-lg-4 mr-auto">
          <p class="lead" ;align="center"> 짝궁 용수 고마워</p>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">19, Buil-ro 568beonga-gil,<br> Bucheon-si, Gyeonggi-do,<br> Republic of Korea</p>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; charleshong Website 2019</small>
    </div>
  </section>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-11" style="" >
                ...
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">파파고 번역기</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
	...
	<div id="wrap-container">
		<div id="wrap1">
          ...
          -webkit-appearance: none;">
            ...
            style="width: 100%; height: 300px; border: 0; padding: 10px; overflow-y: hidden; background: clear;resize:none ; border: medium dashed #1abc9c;" 
            ></textarea>
				</div>
			</div>
		</div>
          ...
          -webkit-appearance: none;">
				...
				<div class="content-box">
					<textarea name="air_type"  placeholder="번역내용" id="result"
						style="width: 80px%; height: 300px; border: 0; padding: 10px; overflow-y: hidden; background: clear;resize:none ; border: medium dashed #1abc9c">
						</textarea>
				</div>
			</div>
		</div>
		<div id="wrap3">
			<div id="footer">
				<button id="btn" class="btn btn-primary">번역하기</button>
			</div>
		</div>
	</div>
                <!-- Portfolio Modal - Text -->
                
                <p class="mb-5"> * 로그인을 해야 파파고 번역기 이용이 가능합니다.
                <br> * 네이버의 papago API를 받아 처리 합니다.
                <br> * 사용기술로는 java-script , ajax , html , css , jqury ,DB ,mybatis 등등이 사용 되었습니다.
                <br> * 한번 번역이 완료된것은 DB에서 확인 후 같은 값이 있으면 DB에서 불러와서 처리가 됩니다.
                </p>
